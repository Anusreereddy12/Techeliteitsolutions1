...
const staticCourses = [
  {
    id: 1, slug: 'python-full-stack', level: 'Intermediate', rating: '4.9',
    title: 'Python Full Stack Development', duration: '6 Months', students: '1200+ students',
    description: 'Master Python, Django, and React to build full-stack web applications.',
    topics: ['Python Basics', 'Django Framework', 'React.js', 'REST APIs', 'Deployment'],
    price: '₹45,000',
  },
  {
    id: 2, slug: 'java-full-stack', level: 'Intermediate', rating: '4.8',
    title: 'Java Full Stack Development', duration: '6 Months', students: '980+ students',
  ...
  {
    id: 3, slug: 'mern-stack', level: 'Beginner', rating: '4.9',
    title: 'MERN Stack Development', duration: '5 Months', students: '1500+ students',
  ...
  {
    id: 4, slug: 'data-science-ai', level: 'Advanced', rating: '4.9',
    title: 'Data Science & AI', duration: '6 Months', students: '850+ students',
    description: 'Master ML and AI with real-world datasets and projects.',
    topics: ['Python & R', 'ML Algorithms', 'Deep Learning', 'AI Models', 'Projects'],
    price: '₹50,000',
  },
  {
    id: 5, slug: 'software-testing', level: 'Beginner', rating: '4.7',
    title: 'Software Testing', duration: '3 Months', students: '700+ students',
    description: 'Manual and automation testing with industry certification prep.',
    topics: ['Manual Testing', 'Selenium', 'API Testing', 'Automation', 'Certification'],
    price: '₹25,000',
  },
  {
    id: 6, slug: 'devops-engineering', level: 'Advanced', rating: '4.8',
    title: 'DevOps Engineering', duration: '5 Months', students: '600+ students',
...
export function OnlineCourses() {
  ...
  useEffect(() => {
    fetch('http://127.0.0.1:8000/api/courses/online/')
      .then(res => res.json())
      .then(data => {
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                  ...
                  <Link to={`/course/${course.slug}`} className="bg-blue-600 text-white px-6 py-2 rounded-lg font-semibold hover:bg-blue-700 transition-colors">
                    View Details
                  </Link>
                </div>
              </div>
