...
const staticCourses = [
  { id: 1, title: 'Python Full Stack Development', duration: '6 Months', students: '20/batch', rating: '4.9', location: 'Bangalore', schedule: 'Mon-Fri, 10 AM - 1 PM', description: 'Intensive classroom training with hands-on projects and mentorship.', topics: ['Python Basics', 'Django Framework', 'React.js', 'REST APIs', 'Deployment'], price: '₹55,000' },
  { id: 2, title: 'Java Full Stack Development', duration: '6 Months', students: '20/batch', rating: '4.8', location: 'Bangalore', schedule: 'Mon-Fri, 2 PM - 5 PM', description: 'Comprehensive Java and Spring Boot training with enterprise projects.', topics: ['Core Java', 'Spring Boot', 'Angular', 'Microservices', 'Database'], price: '₹58,000' },
  { id: 3, title: 'MERN Stack Development', duration: '5 Months', students: '20/batch', rating: '4.9', location: 'Bangalore', schedule: 'Mon-Fri, 10 AM - 1 PM', description: 'Build full-stack applications with modern JavaScript technologies.', topics: ['MongoDB', 'Express.js', 'React.js', 'Node.js', 'Real Projects'], price: '₹52,000' },
  { id: 4, title: 'Data Science & AI', duration: '6 Months', students: '15/batch', rating: '4.9', location: 'Bangalore', schedule: 'Sat-Sun, 10 AM - 4 PM', description: 'Weekend batches for working professionals. Master ML and AI.', topics: ['Python & R', 'ML Algorithms', 'Deep Learning', 'AI Models', 'Projects'], price: '₹60,000' },
  { id: 5, title: 'Software Testing', duration: '3 Months', students: '25/batch', rating: '4.7', location: 'Bangalore', schedule: 'Mon-Fri, 6 PM - 8 PM', description: 'Evening batch for manual and automation testing certification.', topics: ['Manual Testing', 'Selenium', 'API Testing', 'Automation', 'Certification'], price: '₹30,000' },
  { id: 6, title: 'DevOps Engineering', duration: '5 Months', students: '20/batch', rating: '4.8', location: 'Bangalore', schedule: 'Mon-Fri, 2 PM - 5 PM', description: 'Learn CI/CD, containerization, and cloud infrastructure.', topics: ['Jenkins', 'Docker', 'Kubernetes', 'Git', 'AWS DevOps'], price: '₹48,000' },
];
    ...
    <div className="min-h-screen bg-white pt-24 pb-16">
      <div className="max-w-7xl mx-auto px-6">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">Experience hands-on learning in our state-of-the-art training centers. Small batches, personal attention, and direct mentorship.</p>
        </motion.div>
          ...
          {courses.map((course: any, index: number) => (
            <motion.div key={course.id} initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: index * 0.1 }}
              ...
              <div className="bg-gradient-to-br from-blue-600 to-indigo-600 p-6 text-white">
                ...
                <div className="flex items-center gap-2 text-sm bg-white/20 px-3 py-1 rounded-lg"><Calendar size={14} /><span>{course.schedule}</span></div>
              </div>
              <div className="p-6">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 1 }}
          ...
          <Link to="/booking" className="inline-block bg-white text-blue-600 px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-all">Book Free Demo Class</Link>
        </motion.div>
      </div>
    </div>
  );
