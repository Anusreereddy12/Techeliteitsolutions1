...
const staticCourses = [
  {
    ...
    duration: '4 Months', students: '20/batch', rating: '4.9', location: 'Hyderabad',
  ...
  },
  {
    ...
    duration: '5 Months', students: '20/batch', rating: '4.8', location: 'Hyderabad',
  ...
  },
  {
    ...
    duration: '5 Months', students: '15/batch', rating: '4.9', location: 'Hyderabad',
    schedule: 'Mon-Fri, 10 AM - 1 PM',
  ...
  },
  {
    ...
    duration: '4 Months', students: '20/batch', rating: '4.7', location: 'Hyderabad',
  ...
  },
  {
    ...
    duration: '6 Months', students: '20/batch', rating: '4.9', location: 'Hyderabad',
  ...
  },
  {
    ...
    duration: '4 Months', students: '25/batch', rating: '4.7', location: 'Hyderabad',
    schedule: 'Mon-Fri, 6 PM - 8 PM',
  ...
  },
  {
    ...
    duration: '3 Months', students: '20/batch', rating: '4.8', location: 'Hyderabad',
    schedule: 'Mon-Fri, 10 AM - 1 PM',
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <div className="space-y-4">
                  {[
                    { icon: MapPin,   label: 'Address',  value: 'TechElite IT Solutions, Hyderabad, Telangana', sub: 'www.techeliteitsolutions.com' },
