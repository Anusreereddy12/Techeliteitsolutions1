...
const placementProcess = [
  ...
  { step: '4', title: 'Job Referrals',         description: 'Direct referrals to our 100+ hiring partner companies'                        },
  { step: '5', title: 'Interview Scheduling',  description: 'We schedule interviews with companies matching your profile'                  },
  { step: '6', title: 'Offer Support',         description: 'Guidance on offer negotiation and career planning'                            },
];
