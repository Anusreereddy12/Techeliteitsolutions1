...
import { Target, Eye, Award, Users, TrendingUp, CheckCircle, BookOpen, Headphones, Infinity, ChevronRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white dark:bg-[#0d1117]">
      ...
      <div className="pt-24 pb-0">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="text-center mb-10">
            ...
            <p className="text-xl text-gray-500 dark:text-slate-400 max-w-3xl mx-auto">Empowering individuals with cutting-edge IT skills for successful careers</p>
          </motion.div>

          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2 }}
            className="relative rounded-2xl overflow-hidden shadow-xl mb-20" style={{ height: 'clamp(280px, 45vw, 480px)' }}>
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 md:p-12">
              <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.6 }}
                className="text-white/90 text-lg md:text-2xl font-semibold max-w-2xl leading-snug" style={{ fontFamily: "'Exo 2', sans-serif" }}>
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }} className="mb-20">
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-[#1c2230] dark:to-[#1a2040] rounded-2xl p-8 md:p-12 border border-blue-100 dark:border-[#2d3748]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
          {[
            ...
            <motion.div key={i} initial={{ opacity: 0, x: i === 0 ? -30 : 30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.4 }}
              ...
              <div className="w-16 h-16 bg-blue-100 dark:bg-blue-900/40 rounded-xl flex items-center justify-center mb-6">
        ...
        {/* ── Why Choose ── */}
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.6 }} className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <motion.div key={index} initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.7 + index * 0.1 }}
                className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-[#1c2230] dark:to-[#1a2040] border border-blue-100 dark:border-[#2d3748] rounded-xl p-6 hover:shadow-lg dark:hover:shadow-[0_8px_30px_rgba(0,0,0,0.4)] transition-shadow">
                <item.icon className="text-blue-600 dark:text-blue-400 mb-4" size={32} />
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.8 }}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[{ number: '5000+', label: 'Students Trained' }, { number: '50+', label: 'Expert Trainers' }, { number: '100+', label: 'Hiring Partners' }, { number: '95%', label: 'Placement Rate' }].map((stat, index) => (
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-14 lg:gap-20">
            <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }} className="flex-1">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-blue-200 dark:border-blue-800 bg-white dark:bg-[#1c2230] text-blue-600 dark:text-blue-400 text-sm font-semibold mb-5 shadow-sm">
                <span className="w-1.5 h-1.5 rounded-full bg-blue-500" /> About Us
              </div>
              <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white mb-5 leading-tight" style={{ fontFamily: "'Exo 2', sans-serif" }}>
                Who <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-500">We Are</span>
              </h2>
              <p className="text-gray-500 dark:text-slate-400 text-lg leading-relaxed mb-5">We are providing the best quality online courses. Our all instructors are highly expert.</p>
              <p className="text-gray-500 dark:text-slate-400 text-base leading-relaxed mb-8">We are a leading provider of comprehensive IT solutions, dedicated to empowering businesses with cutting-edge technology and exceptional service.</p>
            ...
            <motion.div initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7, delay: 0.15 }} className="flex-1 w-full">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-blue-100 dark:shadow-[0_20px_60px_rgba(0,0,0,0.5)]">
                <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=900&q=80&fit=crop" alt="Team" className="w-full h-[420px] object-cover" />
                <div className="absolute inset-0 bg-gradient-to-t from-blue-900/40 to-transparent" />
                <div className="absolute bottom-6 left-6 bg-white/95 dark:bg-[#1c2230]/95 backdrop-blur-sm rounded-xl px-5 py-4 shadow-lg">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900/40 flex items-center justify-center">
                      <Users className="w-5 h-5 text-blue-600 dark:text-blue-400" />
                    </div>
                    <div>
                      <div className="text-xl font-black text-gray-900 dark:text-white" style={{ fontFamily: "'Exo 2', sans-serif" }}>5000+</div>
      ...
      <section className="py-24 bg-white dark:bg-[#0d1117] relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-16">
            ...
            <p className="text-gray-400 dark:text-slate-500 text-lg max-w-xl mx-auto">Everything you need to accelerate your IT career — all in one place.</p>
          </motion.div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              { icon: Infinity,   iconBg: 'bg-sky-100 dark:bg-sky-900/40',     iconColor: 'text-sky-600 dark:text-sky-400',     bar: 'from-sky-500 to-blue-500',      border: 'border-sky-100 dark:border-sky-900 hover:border-sky-300 dark:hover:border-sky-700',       title: 'Life Time Access',       description: "Our commitment to your success doesn't end with the implementation of our solutions. We provide continuous support and maintenance to ensure lasting value." },
            ].map((card, index) => {
              ...
              return (
                <motion.div key={index} initial={{ opacity: 0, y: 35 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: index * 0.15 }} whileHover={{ y: -6 }}
                  className={`group relative bg-white dark:bg-[#1c2230] border ${card.border} rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden`}>
                  ...
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4" style={{ fontFamily: "'Exo 2', sans-serif" }}>{card.title}</h3>
                  <p className="text-gray-500 dark:text-slate-400 leading-relaxed text-[0.92rem]">{card.description}</p>
                </motion.div>
              );
            })}
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
            <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }} className="flex-1 w-full">
              <div className="relative rounded-2xl overflow-hidden shadow-xl shadow-blue-100 dark:shadow-[0_20px_60px_rgba(0,0,0,0.5)]">
                <img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=900&q=80&fit=crop" alt="Dashboard" className="w-full h-[420px] object-cover" />
                <div className="absolute inset-0 bg-gradient-to-br from-blue-600/20 to-indigo-700/20" />
                <div className="absolute top-6 right-6 bg-white/95 dark:bg-[#1c2230]/95 backdrop-blur-sm rounded-xl px-4 py-3 shadow-lg">
            ...
            <motion.div initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7, delay: 0.15 }} className="flex-1 w-full">
              ...
              <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white mb-3 leading-tight" style={{ fontFamily: "'Exo 2', sans-serif" }}>
                Our <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-500">Skills</span>
              </h2>
              <p className="text-gray-500 dark:text-slate-400 text-base mb-10">Industry-validated expertise across every modern IT domain.</p>
      ...
      <section className="py-20 bg-white dark:bg-[#0d1117] relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-14">
            ...
            <p className="text-gray-400 dark:text-slate-500 text-lg">Proven results that define our commitment to excellence</p>
          </motion.div>
            ...
            {[
              ...
              return (
                <motion.div key={index} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.55, delay: index * 0.12 }} whileHover={{ y: -4 }}
                  className={`group relative bg-white dark:bg-[#1c2230] border border-gray-100 dark:border-[#2d3748] rounded-2xl p-6 shadow-md ${stat.shadow} hover:shadow-xl transition-all duration-300 overflow-hidden text-center`}>
                  ...
                  <div className="text-3xl font-black text-gray-900 dark:text-white mb-1" style={{ fontFamily: "'Exo 2', sans-serif" }}>{stat.number}</div>
                  <div className="text-gray-500 dark:text-slate-400 text-sm font-semibold uppercase tracking-wide">{stat.label}</div>
      ...
      <div className="max-w-7xl mx-auto px-6 pb-20">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">Ready to Start Your Journey?</h2>
          <p className="text-xl text-gray-600 dark:text-slate-400 mb-8">Join thousands of successful professionals who started their careers with us</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/booking" className="bg-blue-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-blue-700 transition-all">Book Free Demo</Link>
            <Link to="/contact" className="bg-white dark:bg-[#1c2230] border-2 border-blue-600 text-blue-600 dark:text-blue-400 dark:border-blue-500 px-8 py-4 rounded-lg font-semibold hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all">Contact Us</Link>
          </div>
        </motion.div>
      </div>
