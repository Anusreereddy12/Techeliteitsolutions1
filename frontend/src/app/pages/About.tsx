...
/>
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <motion.div
          ...
          className="mb-20"
        >
          <h2 className="text-3xl font-bold text-gray-900 mb-12 text-center">Why Choose TechElite?</h2>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-14 lg:gap-20">
            ...
            <motion.div
              ...
              className="flex-1"
            >
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-blue-200 bg-white text-blue-600 text-sm font-semibold mb-5 shadow-sm">
                <span className="w-1.5 h-1.5 rounded-full bg-blue-500" />
                About Us
              </div>
              <h2
            ...
            {[
              ...
              return (
                <motion.div
                  ...
                  whileHover={{ y: -6 }}
                  className={`group relative bg-white border ${card.border} rounded-2xl p-8 shadow-sm hover:shadow-xl ${card.shadow} transition-all duration-300 overflow-hidden`}
                >
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-xl shadow-blue-100">
                ...
                <div className="absolute top-6 right-6 bg-white/95 backdrop-blur-sm rounded-xl px-4 py-3 shadow-lg">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-bold text-gray-700 uppercase tracking-wider">100% Job Ready</span>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            {[
              ...
              return (
                <motion.div
                  ...
                  whileHover={{ y: -4 }}
                  className={`group relative bg-white border border-gray-100 rounded-2xl p-6 shadow-md ${stat.shadow} hover:shadow-xl transition-all duration-300 overflow-hidden text-center`}
                >
