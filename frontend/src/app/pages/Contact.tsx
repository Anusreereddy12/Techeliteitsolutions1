  ...
  const inner = (
    <motion.div
      ...
      style={{
        ...
        boxShadow: '0 2px 12px rgba(80,100,180,0.06)',
      }}
      onMouseEnter={e => {
    ...
    >
      ...
      <div
        className="w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0 opacity-40 group-hover:opacity-90 transition-all duration-300"
        style={{
          background: 'rgba(219,234,254,0.6)',
          border: '1px solid rgba(147,197,253,0.4)',
        }}
...
export function Contact() {
  ...
  const inputStyle: React.CSSProperties = {
    ...
    border: '1px solid rgba(180,200,240,0.6)',
    color: '#1e293b',
    borderRadius: '10px',
    width: '100%',
    padding: '14px 16px',
  ...
  return (
    <div
      ...
      style={{
        fontFamily: "'DM Sans', 'Exo 2', sans-serif",
        background: '#f5f7fa',
      }}
    >
      {/* ══ BACKGROUND ══ */}
      <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
        ...
        {/* Soft blue-grey radial glow top center */}
        <div
          className="absolute"
          style={{
            top: '-15%',
            ...
            width: '1000px',
            height: '700px',
            background: 'radial-gradient(ellipse at 50% 20%, rgba(99,131,200,0.13) 0%, rgba(120,150,220,0.07) 40%, transparent 68%)',
          }}
        />
        ...
        <div
          ...
          style={{
            backgroundImage: 'radial-gradient(circle, rgba(80,100,160,0.13) 1px, transparent 1px)',
        ...
        <svg className="absolute top-0 left-0 w-80 h-80" viewBox="0 0 320 320" fill="none">
          ...
          <circle cx="48" cy="100" r="3" stroke="rgba(80,100,180,0.22)" strokeWidth="1.2" fill="none"/>
          <path d="M0 60 H40 Q52 60 52 72 V110" stroke="rgba(80,100,180,0.1)" strokeWidth="1"/>
          <path d="M0 180 H60 Q72 180 72 192 V240" stroke="rgba(80,100,180,0.09)" strokeWidth="1"/>
        </svg>
        ...
        <svg className="absolute top-0 right-0 w-80 h-80" viewBox="0 0 320 320" fill="none">
          ...
          <circle cx="248" cy="80" r="3" stroke="rgba(80,100,180,0.22)" strokeWidth="1.2" fill="none"/>
          <path d="M320 160 H270 Q258 160 258 172 V220" stroke="rgba(80,100,180,0.09)" strokeWidth="1"/>
        </svg>

        {/* Bottom corners */}
        <svg className="absolute bottom-0 left-0 w-56 h-56" viewBox="0 0 224 224" fill="none">
          <path d="M0 160 H60 Q72 160 72 148 V100" stroke="rgba(80,100,180,0.12)" strokeWidth="1"/>
          <circle cx="60" cy="160" r="3" stroke="rgba(80,100,180,0.15)" strokeWidth="1" fill="none"/>
        </svg>
        <svg className="absolute bottom-0 right-0 w-56 h-56" viewBox="0 0 224 224" fill="none">
          <path d="M224 160 H164 Q152 160 152 148 V100" stroke="rgba(80,100,180,0.12)" strokeWidth="1"/>
          <circle cx="164" cy="160" r="3" stroke="rgba(80,100,180,0.15)" strokeWidth="1" fill="none"/>
        </svg>
      </div>
        ...
        >
          <motion.span
            ...
            style={{
              ...
              color: 'transparent',
              WebkitTextStroke: '2px rgba(60,80,160,0.12)',
              backgroundImage: 'linear-gradient(180deg, rgba(80,100,200,0.11) 0%, rgba(80,100,200,0.04) 100%)',
          ...
          <motion.div {...fadeIn(0.05, 0.6)} className="mb-8">
            ...
            >
              <div
                ...
                style={{ borderColor: 'rgba(100,140,220,0.4)', color: '#6b8fd4' }}
              >◎</div>
              Contact
            </div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[400px_1fr] gap-10 xl:gap-14 items-start">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex flex-col gap-3">
                <motion.div {...fadeUp(0.18)}>
                  <InfoCard icon={Mail}   label="Email us"      value="info@techelite.in"
                    href="mailto:info@techelite.in" />
                </motion.div>
                <motion.div {...fadeUp(0.23)}>
                  <InfoCard icon={Phone}  label="Call us"       value="+91 98765 43210"
                    href="tel:+919876543210" />
                </motion.div>
                <motion.div {...fadeUp(0.28)}>
                  <InfoCard icon={MapPin} label="Our location"  value="Plot 42, Tech Park Lane, Hitech City, Hyderabad" />
                </motion.div>
            ...
            <motion.div
              ...
              style={{
                ...
                boxShadow: '0 8px 48px rgba(80,100,180,0.1), inset 0 1px 0 rgba(255,255,255,0.9)',
              }}
            >
            ...
            {[
              ...
              <motion.div
                ...
                style={{
                  ...
                  boxShadow: '0 2px 12px rgba(80,100,180,0.05)',
                }}
                onMouseEnter={e => {
                  const el = e.currentTarget as HTMLElement;
                  el.style.background = 'rgba(255,255,255,0.95)';
                  el.style.borderColor = 'rgba(99,131,220,0.4)';
                  el.style.boxShadow = '0 8px 28px rgba(80,100,180,0.12)';
                }}
                onMouseLeave={e => {
                  const el = e.currentTarget as HTMLElement;
                  el.style.background = 'rgba(255,255,255,0.75)';
                  el.style.borderColor = 'rgba(180,200,240,0.5)';
                  el.style.boxShadow = '0 2px 12px rgba(80,100,180,0.05)';
                }}
              >
      ...
      <motion.div {...fadeUp(0.35)} className="relative z-10 w-full">
        <div className="max-w-6xl mx-auto px-6 lg:px-10 mb-5">
          <div className="flex items-center gap-4">
            ...
            <div
              className="flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-semibold uppercase tracking-wider"
              style={{
                background: 'rgba(219,234,254,0.6)',
                border: '1px solid rgba(147,197,253,0.5)',
                color: '#4b6fa8',
          ...
          <p className="text-center text-xs font-medium mt-2" style={{ color: '#94a3b8' }}>
            Easily accessible via metro — Hitech City Station (500m)
          </p>
        </div>
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              backdropFilter: 'blur(12px)',
              border: '1px solid rgba(180,200,240,0.6)',
              boxShadow: '0 8px 24px rgba(80,100,180,0.14)',
            }}
          >
            <div
