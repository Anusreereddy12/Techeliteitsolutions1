...
const programs = [
  ...
  },
  {
    ...
    glow: 'group-hover:shadow-amber-300',
  },
  {
  ...
  },
  {
    ...
    glow: 'group-hover:shadow-sky-300',
  },
  {
    ...
    <div className="min-h-screen bg-white dark:bg-slate-900">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-10">
            <div className="flex-1 text-center lg:text-left">
              <motion.div
                ...
                className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-blue-300 bg-blue-50 dark:bg-blue-900/40 text-blue-700 text-sm font-semibold mb-6 shadow-sm"
              >
              ...
              >
                ...
                <Link
                  to="/courses/online"
                  className="border-2 border-blue-500 text-blue-600 bg-white dark:bg-slate-900 px-8 py-4 rounded-xl text-lg font-semibold hover:bg-blue-50 dark:bg-blue-900/40 hover:border-blue-600 hover:shadow-md transition-all duration-300"
                >
                  View Courses
                </Link>
              </motion.div>
              ...
              >
                {[
                  ...
                  <motion.div
                    key={index}
                    className="group relative bg-white dark:bg-slate-900 border border-blue-100 rounded-2xl p-5 shadow-sm hover:shadow-md hover:border-blue-300 hover:bg-blue-50 dark:bg-blue-900/40 transition-all duration-300"
                  ...
                  >
                    ...
                    <div className="text-2xl font-black text-gray-900 dark:text-white mb-1" style={{ fontFamily: "'Exo 2', sans-serif" }}>
                      {stat.number}
                    </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-7">
            {[
              ...
              <motion.div
                ...
                whileHover={{ y: -5 }}
                className={`group relative bg-white dark:bg-slate-900 border ${feature.accent} rounded-2xl p-8 shadow-sm hover:shadow-lg ${feature.shadow} transition-all duration-300 overflow-hidden`}
              >
                ...
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3" style={{ fontFamily: "'Exo 2', sans-serif" }}>
                  {feature.title}
                </h3>
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 xl:px-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-blue-200 bg-white dark:bg-slate-900 text-blue-600 text-sm font-semibold mb-4 shadow-sm">
              <span className="w-1.5 h-1.5 rounded-full bg-blue-500" />
              Our Programs
            </div>
            <h2
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="absolute inset-[3px] rounded-full bg-white dark:bg-slate-900/10" />
                    ...
                    <motion.h3
                      ...
                      className="text-[0.9rem] font-extrabold text-gray-900 dark:text-white mb-2 leading-snug px-1"
                      style={{ fontFamily: "'Exo 2', sans-serif" }}
                    >
                      {program.title}
                    </motion.h3>
