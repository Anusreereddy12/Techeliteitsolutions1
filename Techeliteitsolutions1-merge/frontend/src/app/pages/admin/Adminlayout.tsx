...
export function AdminLayout() {
  ...
  const SidebarInner = ({ mini }: { mini: boolean }) => (
    <div className="flex flex-col h-full">
      ...
      <div className="mx-3 h-px bg-white dark:bg-slate-900/[0.07] mb-4" />
            ...
            <Link key={to} to={to} onClick={() => setMobileOpen(false)}
              className={`relative flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all duration-150 group
                ...
                ${active
                  ...
                  : 'text-slate-400 hover:bg-white dark:bg-slate-900/[0.06] hover:text-white'
                }`}
            >
      ...
      <div className="px-2 pb-4 mt-4 space-y-0.5">
        <div className="mx-1 h-px bg-white dark:bg-slate-900/[0.07] mb-3" />

        <Link to="/" onClick={() => setMobileOpen(false)}
          className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-400 hover:bg-white dark:bg-slate-900/[0.06] hover:text-white transition-all ${mini ? 'justify-center px-2' : ''}`}
        >
        ...
        {!mini && (
          <div className="flex items-center gap-2.5 px-3 py-2.5 mt-1 rounded-xl bg-white dark:bg-slate-900/[0.04] border border-white/[0.06]">
  ...
  return (
    <div className="flex h-screen bg-[#f1f5f9] overflow-hidden" style={{ fontFamily: "'Exo 2', sans-serif" }}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        {/* Topbar */}
        <header className="bg-white dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200/80 px-6 py-3.5 flex items-center justify-between shrink-0">
