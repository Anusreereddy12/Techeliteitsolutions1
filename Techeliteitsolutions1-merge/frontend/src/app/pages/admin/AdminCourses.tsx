        ...
        <div className="grid grid-cols-1 gap-4">
          {courses.map((c, i) => (
            <motion.div key={c.id}
              ...
              className={`bg-white dark:bg-slate-900 rounded-2xl border shadow-sm p-5 transition-all hover:shadow-md ${c.is_active ? 'border-slate-100' : 'border-slate-200 opacity-60'}`}
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex items-center gap-1 shrink-0">
                  ...
                  <button onClick={() => openEdit(c)} className="p-2 rounded-lg hover:bg-blue-50 dark:bg-blue-900/40 transition-colors text-slate-400 hover:text-blue-600">
                    <Edit2 size={16} />
                  </button>
        ...
        {showForm && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-[95%] max-w-2xl bg-white dark:bg-slate-900 rounded-2xl shadow-2xl overflow-hidden"
            >
