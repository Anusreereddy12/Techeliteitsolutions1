    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white" style={{ fontFamily: "'Exo 2', sans-serif" }}>
              Announcement Bar
            </h1>
          </div>
      ...
      {items.filter(i => i.is_active).length > 0 && (
        <div className="mb-6 rounded-2xl overflow-hidden border border-blue-100 shadow-sm">
          <div className="px-4 py-2 bg-blue-50 dark:bg-blue-900/40 border-b border-blue-100 text-xs font-semibold text-blue-600 uppercase tracking-wider">
            Live Preview
          </div>
          <div
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1 flex-wrap">
                  ...
                  <span className={`text-xs px-2 py-0.5 rounded-full font-semibold ${item.is_active ? 'bg-emerald-50 text-emerald-600' : 'bg-gray-100 dark:bg-slate-800 text-gray-400'}`}>
                    {item.is_active ? 'Active' : 'Inactive'}
                  </span>
                  <span className="text-xs text-gray-300">order: {item.order}</span>
                </div>
                <p className="text-sm text-gray-800 dark:text-gray-100 font-medium truncate">{item.text}</p>
                {item.link && (
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                <button
                  ...
                  className="text-xs font-semibold text-gray-500 hover:text-blue-600 px-3 py-1.5 rounded-lg hover:bg-blue-50 dark:bg-blue-900/40 transition-colors border border-transparent hover:border-blue-100"
                >
                  Edit
                </button>
                <button
      ...
      {showForm && (
        <>
          ...
          <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-[90%] max-w-lg bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-gray-100 dark:border-slate-800 p-6">
            <div className="flex items-center justify-between mb-5">
              <h2 className="text-lg font-bold text-gray-900 dark:text-white" style={{ fontFamily: "'Exo 2', sans-serif" }}>
                {editId ? 'Edit Announcement' : 'New Announcement'}
              </h2>
              <button onClick={closeForm} className="text-gray-400 hover:text-gray-600 dark:text-gray-300 p-1"><X size={18} /></button>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2.5 rounded-xl border border-gray-200 dark:border-slate-700 text-sm outline-none focus:border-blue-400 resize-none transition-colors"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2.5 rounded-xl border border-gray-200 dark:border-slate-700 text-sm outline-none focus:border-blue-400 transition-colors"
                  />
                </div>
                <div>
            ...
            <div className="flex gap-3 mt-6">
              <button onClick={closeForm} className="flex-1 py-2.5 rounded-xl border border-gray-200 dark:border-slate-700 text-sm font-semibold text-gray-500 hover:bg-gray-50 dark:bg-slate-800/50 transition-colors">
                Cancel
              </button>
              <button
                onClick={handleSave}
