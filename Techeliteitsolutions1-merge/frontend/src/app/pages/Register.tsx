...
export function Register() {
  ...
  const inputCls = "w-full h-11 px-4 rounded-xl text-sm text-white placeholder-white/25 outline-none transition-all dark:bg-slate-800 dark:text-white duration-200";
