    ...
    <div className="min-h-screen bg-white dark:bg-slate-900 pt-24 pb-16">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <motion.div
          ...
          className="mb-20"
        >
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-12 text-center">Our Placement Process</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {placementProcess.map((item, index) => (
              <motion.div
                ...
                className="bg-white dark:bg-slate-900 border-2 border-gray-100 dark:border-slate-800 rounded-xl p-6 hover:border-blue-200 hover:shadow-lg transition-all"
              >
              ...
              >
                ...
                <div className="mb-4 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <Building className="text-gray-600 dark:text-gray-300" size={18} />
                    <span className="font-semibold text-gray-900 dark:text-white">{story.company}</span>
                  </div>
        ...
        <motion.div
          ...
          className="mb-20"
        >
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-12 text-center">Our Hiring Partners</h2>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
              {hiringPartners.map((company, index) => (
                <motion.div
                  ...
                  className="bg-white dark:bg-slate-900 rounded-lg p-6 flex items-center justify-center font-semibold text-gray-700 dark:text-gray-200 hover:shadow-lg transition-shadow"
                >
                  {company}
                </motion.div>
              ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <motion.div
                ...
                className="flex items-center gap-3 bg-white dark:bg-slate-900 border-2 border-gray-100 dark:border-slate-800 rounded-xl p-6 hover:border-blue-200 transition-colors"
              >
                <CheckCircle className="text-blue-600 flex-shrink-0" size={24} />
                <span className="text-gray-900 dark:text-white font-medium">{offer}</span>
              </motion.div>
            ))}
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/booking"
              className="bg-white dark:bg-slate-900 text-blue-600 px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 dark:bg-slate-800 transition-all"
            >
              Enroll Now
            </Link>
            <Link
              to="/contact"
              className="bg-transparent border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white dark:bg-slate-900/10 transition-all"
            >
              Talk to Counselor
            </Link>
          </div>
