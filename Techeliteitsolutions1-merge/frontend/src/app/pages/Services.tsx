...
export function Services() {
      ...
      <section className="relative pt-28 pb-24 overflow-hidden bg-gradient-to-b from-slate-50 via-blue-50/30 to-white">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 xl:gap-20 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-blue-200 bg-white dark:bg-slate-900/80 text-blue-600 text-sm font-semibold mb-5 shadow-sm">
                ...
                {[
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="text-gray-700 dark:text-gray-200 font-medium text-sm">{b.text}</span>
                    </motion.div>
                  );
                })}
              </div>
                ...
                {[
                  ...
                  return (
                    ...
                    >
                      ...
                      <div>
                        <div className="text-lg font-black text-gray-900 dark:text-white leading-none" style={{ fontFamily: "'Exo 2', sans-serif" }}>{t.value}</div>
  ...
  <motion.div
    ...
    className="flex-1"
  >
    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-blue-200 bg-blue-50 dark:bg-blue-900/40 text-blue-600 text-sm font-semibold mb-5">
      <span className="w-1.5 h-1.5 rounded-full bg-blue-500" />
      Who We Are
    </div>

    <h2
      className="text-3xl md:text-4xl font-extrabold text-gray-900 dark:text-white mb-5 leading-tight"
      style={{ fontFamily: "'Exo 2', sans-serif" }}
    >
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
      {[
        ...
        <div key={i} className="flex items-center gap-2.5">
          ...
          <span className="text-sm text-gray-700 dark:text-gray-200 font-medium">{pt}</span>
        </div>
      ))}
    </div>
  </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { icon: Headphones, title: '24/7 Mentor Support',        desc: 'Our mentors are available round the clock — no question goes unanswered.', color: 'text-blue-600', bg: 'bg-blue-50 dark:bg-blue-900/40' },
              ...
              return (
                <motion.div
                  ...
                  whileHover={{ y: -5 }}
                  className="group bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 hover:border-blue-200 rounded-2xl p-7 shadow-sm hover:shadow-lg transition-all duration-300"
                >
                  ...
                  <h3 className="font-bold text-gray-900 dark:text-white mb-2 text-base" style={{ fontFamily: "'Exo 2', sans-serif" }}>{item.title}</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 relative">
            ...
            {[
              ...
              >
                ...
                <h3 className="font-bold text-gray-900 dark:text-white text-base mb-2" style={{ fontFamily: "'Exo 2', sans-serif" }}>{step.title}</h3>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link to="/booking"        className="bg-white dark:bg-slate-900 text-blue-600 px-8 py-4 rounded-xl font-semibold hover:bg-gray-50 dark:bg-slate-800/50 transition-all shadow-sm">Book Free Demo</Link>
                <Link to="/courses/online" className="bg-transparent border-2 border-white/70 text-white px-8 py-4 rounded-xl font-semibold hover:bg-white dark:bg-slate-900/10 transition-all">View All Courses</Link>
              </div>
            </div>
          </motion.div>
        </div>
