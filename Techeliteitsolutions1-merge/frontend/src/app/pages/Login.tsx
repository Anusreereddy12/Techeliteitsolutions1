          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <input id="email" type="email" name="email"
                ...
                className="w-full h-12 px-4 rounded-xl text-sm text-white outline-none transition-all dark:bg-slate-800 dark:text-white duration-200"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input id="password" name="password"
                  ...
                  className="w-full h-12 pl-4 pr-12 rounded-xl text-sm text-white outline-none transition-all dark:bg-slate-800 dark:text-white duration-200"
                  style={{ ...inputStyle, color: "white", caretColor: "white" }}
                />
