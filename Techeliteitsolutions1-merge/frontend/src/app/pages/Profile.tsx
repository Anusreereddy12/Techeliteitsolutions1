    ...
    <div className="min-h-screen bg-white dark:bg-slate-900">
      ...
      <div className="max-w-7xl mx-auto px-6 pb-20">
          ...
          {achievements.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -4 }}
                className={`group relative bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-2xl p-6 shadow-md ${item.shadow} hover:shadow-xl transition-all duration-300 overflow-hidden text-center`}
              >
                ...
                <div className="text-3xl font-black text-gray-900 dark:text-white mb-1" style={{ fontFamily: "'Exo 2', sans-serif" }}>
                  {item.value}
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            <div className="bg-white dark:bg-slate-900 border-2 border-gray-100 dark:border-slate-800 rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300">
              ...
              <div className="space-y-5">
                {enrolledCourses.map((course, index) => (
                  <motion.div
                    ...
                    className={`group bg-white dark:bg-slate-900 border-2 border-gray-100 dark:border-slate-800 rounded-2xl p-6 hover:border-blue-200 hover:shadow-xl ${course.shadow} transition-all duration-300`}
                  >
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="text-right">
                        <div className="text-2xl font-black text-gray-900 dark:text-white" style={{ fontFamily: "'Exo 2', sans-serif" }}>
                          {course.progress}%
                        </div>
                    ...
                    <div key={i}>
                      ...
                      <div className="relative">
                        ...
                        <input
                          type="password"
                          placeholder="••••••••"
                          className="w-full pl-10 pr-4 py-3 border-2 border-gray-100 dark:border-slate-800 rounded-xl text-sm focus:outline-none focus:border-blue-400 transition-colors"
                        />
                      </div>
                    </div>
                  ))}
        ...
        >
          ...
          >
            <div className="flex items-center justify-between mb-6">
              ...
              <button onClick={() => setIsEditing(false)} className="w-8 h-8 rounded-full bg-gray-100 dark:bg-slate-800 flex items-center justify-center hover:bg-gray-200 transition-colors">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-3 border-2 border-gray-100 dark:border-slate-800 rounded-xl text-sm focus:outline-none focus:border-blue-400 transition-colors resize-none"
                />
              </div>
            </div>
            ...
            <div className="flex gap-3 mt-6">
              <button
                onClick={() => setIsEditing(false)}
                className="flex-1 py-3 border-2 border-gray-200 dark:border-slate-700 rounded-xl text-sm font-semibold text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:bg-slate-800/50 transition-colors"
              >
                Cancel
              </button>
              <button
